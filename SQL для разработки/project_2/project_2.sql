/* 
docker exec -it a451c6b7a6e7 psql -U postgres -- запускам psql в docker
CREATE DATABASE sprint_2; -- создаем БД для выполнения проекта

Восстанавливаем dump используя restore в DBeaver из архива (Выполнилось за доли секунды. Почему-то из файла *.sql процесс восстановления будто зависает и не движется дальше. Ждал минут 5)
*/
